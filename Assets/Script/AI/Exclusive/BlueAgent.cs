...
public class BlueAgent : Agent
{
    ...
    public static BlueAgent instance;
    ...
    private int isMCUsed = 0;


    public override void Initialize()
    {
        if (BlueAgent.initialized)
        {
            return;
        }
        BlueAgent.initialized = true;
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        else
        {
            ...
            sensor.AddObservation(this.isMCUsed);
            ...
            sensor.AddObservation(redCanUse);
    ...
    public override void Heuristic(in ActionBuffers actionsOut)
    {
        ...
        var actionOuts = actionsOut.DiscreteActions;
